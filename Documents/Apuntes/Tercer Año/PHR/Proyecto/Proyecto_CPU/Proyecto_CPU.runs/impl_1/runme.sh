...
HD_PWD='C:/Users/Mirare69/Desktop/cpu_phr/cpu_phr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemoryController.tcl -notrace
