...
HD_PWD='C:/Users/Mirare69/Desktop/cpu_phr/cpu_phr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemoryController.tcl
