...
package test_colisiones is

    ---------------------------------------------------------------------
    ------ SCENARIO ----------------------------------------------------- 
    ---------------------------------------------------------------------
    altura_colision: Altitude_Type := 7000;
    
    Joystick_colision: tipo_Secuencia_Joystick :=  -- 1 muestra cada 100ms.
                ((+00,-90),(+00,-80),(+00,-70),(+00,-60),(+00,-50),  
                 ...
                 (+45,+00),(+45,+00),(+45,+00),(+45,+00),(+45,+00),  --11s.
                 ...
                 (+45,+00),(+45,+00),(+45,+00),(+45,+00),(+45,+00),  
                 (+45,+00),(+45,+00),(+45,+00),(+45,+00),(+45,+00),  --15s.
    ...
    Distancia_colision: tipo_Secuencia_Distancia :=  -- next sample every 100ms.
            ( 5555,5555,5555,5555,5555, 5555,5555,5555,5555,5555,   -- 1s.
              ...
              4500,4500,4500,4500,4500, 4500,4500,4500,4500,4500,   -- 7s.
              4500,4500,4500,4500,4500, 4500,4500,4500,4500,4500,   -- 8s.  
              4500,4500,4500,4500,4500, 4500,4500,4500,4500,4500,   -- 9s.
              4500,4500,4500,4500,4500, 4500,4500,4500,4500,4500,   -- 10s.
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 11s. 
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 12s.
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 13s.
              2000,2000,2000,2000,2000, 2000,2000,2000,2000,2000,   -- 14s.
              2000,2000,2000,2000,2000, 2000,2000,2000,2000,2000,   -- 15s. 
              2000,2000,2000,2000,2000, 2000,2000,2000,2000,2000,   -- 16s.
              1000,1000,1000,1000,4000, 1000,1000,1000,1000,1000,   -- 17s.
              1000,1000,1000,1000,4000, 1000,1000,1000,1000,1000,   -- 18s.
              1000,1000,1000,1000,4000, 1000,1000,1000,1000,1000,   -- 19s.
              500,500,500,500,500, 500,500,500,500,500);	    -- 20s
           
                 
    Light_Intensity_colision: tipo_Secuencia_Light :=  -- 1 muestra cada 100ms.
    ...
    Power_colision: tipo_Secuencia_Power :=  -- next sample every 100ms.
    ...
    PilotPresence_colision: tipo_Secuencia_PilotPresence :=  -- 1 muestra cada 100ms.
    ...
    PilotButton_colision: tipo_Secuencia_PilotButton :=  -- 1 muestra cada 100ms.
