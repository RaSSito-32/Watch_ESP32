...
package test_general is

    ---------------------------------------------------------------------
    ------ SCENARIO general --------------------------------------------- 
    ---------------------------------------------------------------------
    altura_general: Altitude_Type := 5000;
    
    Joystick_general: tipo_Secuencia_Joystick :=  -- 1 muestra cada 100ms.
    ...
    Distancia_general: tipo_Secuencia_Distancia :=  -- next sample every 100ms.
    ...
    Light_Intensity_general: tipo_Secuencia_Light :=  -- 1 muestra cada 100ms.
    ...
    Power_general: tipo_Secuencia_Power :=  -- next sample every 100ms.
    ...
    PilotPresence_general: tipo_Secuencia_PilotPresence :=  -- 1 muestra cada 100ms.
    ...
    PilotButton_general: tipo_Secuencia_PilotButton :=  -- 1 muestra cada 100ms.
