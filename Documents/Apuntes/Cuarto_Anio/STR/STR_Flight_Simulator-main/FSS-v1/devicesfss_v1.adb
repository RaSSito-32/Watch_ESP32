...
with lista_Scenarios; use lista_Scenarios;
...
package body devicesFSS_V1 is
   ...
   --------------------------------------------------------------------------
    ...
    protected Distance_Sensor is
      procedure Get_Distance (D: out Distance_Type);
    private
    ...
    procedure Read_Distance (D: out Distance_Type) is
      begin
        Distance_Sensor.Get_Distance (D);
      end Read_Distance;

    protected body Distance_Sensor is
      procedure Get_Distance (D: out Distance_Type)  is
   ...
   --------------------------------------------------------------------------
    ...
    protected Light_Sensor is
      procedure Get_Light (L: out Light_Type);
    private
    ...
    procedure Read_Light_Intensity (L: out Light_Type) is
      begin
        Light_Sensor.Get_Light (L);
      end Read_Light_Intensity;

    protected body Light_Sensor is
      procedure Get_Light (L: out Light_Type)  is
         type Time_index is delta 0.1 range 0.0..100.0;
         t: Time_index;
      begin
         t := Time_index(To_Duration(Clock - Big_Bang));
   ...
   ---------------------------------------------------------------------
    ...
    protected Joystick is
       procedure Get_Joystick (J: out Joystick_Type);
    private
      i: Indice_Secuencia_Joystick := 1;
      Secuencia: tipo_Secuencia_Joystick :=  Joystick_Simulation;
    end Joystick;

    procedure Read_Joystick (J: out Joystick_Type) is
      begin
        Joystick.Get_Joystick (J);
      end Read_Joystick;

    protected body Joystick is
      procedure Get_Joystick (J: out Joystick_Type)  is
         type Time_index is delta 0.1 range 0.0..100.0;
         t: Time_index;
      begin
         t := Time_index(To_Duration(Clock - Big_Bang));
   ...
   --------------------------------------------------------------------------
    ...
    protected Power_Sensor is
      procedure Get_Power (P: out Power_Type);
    private
    ...
    procedure Read_Power (P: out Power_Type) is
      begin
        Power_Sensor.Get_Power (P);
      end Read_Power;

    protected body Power_Sensor is
      procedure Get_Power (P: out Power_Type)  is
         type Time_index is delta 0.1 range 0.0..100.0;
         t: Time_index;
      begin
         t := Time_index(To_Duration(Clock - Big_Bang));
   ...
   --------------------------------------------------------------------------
    ...
    protected PilotPresence_Sensor is
      function Get_PilotPresence return PilotPresence_Type;
    private
    ...
    function Read_PilotPresence return PilotPresence_Type is
      begin
        return (PilotPresence_Sensor.Get_PilotPresence); 
      end Read_PilotPresence;

    protected body PilotPresence_Sensor  is
      function Get_PilotPresence return PilotPresence_Type is
         type Time_index is delta 0.1 range 0.0..100.0;
         t: Time_index;
         i: Indice_Secuencia_PilotPresence := 1;
      begin
   ...
   -- SPEED --------------------------------------------------------
    ...
    protected Aircraft_Speed_State is
      procedure Set_Speed (P: in Speed_Type);
      function  Get_Speed return Speed_Type;
      procedure Increment_Speed (D: in Speed_Increment_Type);    
    private
      Current_Speed: Speed_Type := 0;
    ...
    procedure Set_Speed (P: in Speed_Type) is 
      begin
    ...
    protected body Aircraft_Speed_State is
      ...
      function Get_Speed return Speed_Type is
        begin
          Execution_Time (WCET_Speed);
      ...
      begin
        Execution_Time (WCET_Speed);
        Current_Speed := Current_Speed + Speed_Type(D);
      end Increment_Speed;
    end Aircraft_Speed_State; 
   ...
   -- ALTITUDE --------------------------------------------------------
    ...
    procedure Write_Altitude (A: in Altitude_Type) is 
    begin
    ...
    protected body Aircraft_Altitude_State is
      procedure Set_Altitude (A: in Altitude_Type)  is
      begin
         Current_Altitude := A;
      ...
      begin
        Execution_Time (WCET_Altitude);
        if (D < 0) then Current_Altitude := Current_Altitude - Altitude_Type(abs(D));
                   else Current_Altitude := Current_Altitude + Altitude_Type(D);
        end if;
      end Increment_Altitude;
    end Aircraft_Altitude_State; 
   ...
   -- PITCH --------------------------------------------------------
    ...
    protected Aircraft_Pitch_State is
      procedure Set_Pitch (P: in Pitch_Type);
      function  Get_Pitch return Pitch_Type;
    ...
    protected body Aircraft_Pitch_State is
      ...
      function Get_Pitch return Pitch_Type is
        begin
          Execution_Time (WCET_Pitch);
...
begin
  ...
  procedure Display_Altitude (A: in Altitude_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Altitude: ");
  ...
  procedure Display_Speed (S: in Speed_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Speed: ");
  ...
  procedure Display_Distance (D: in Distance_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Distance: ");
  ...
  procedure Display_Pitch (P: in Pitch_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Pitch: ");
  ...
  procedure Display_Roll (R: in Roll_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Roll: ");
  ...
  procedure Display_Light_Intensity (L: in Light_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Light_Intensity: ");
  ...
  procedure Display_Pilot_Power (P: in Power_Type) is
  begin
   Print_Chrono; 
   Put ("..# ");
   Put ("Pilot_Power: ");
  ...
  procedure Display_Joystick (J: in Joystick_Type) is
  begin
    Print_Chrono; 
    Put ("..# ");
    Put ("Joystick: ");
    for i in Joystick_Index loop
       Print_an_Integer (Integer(J(i)));
    end loop;
    Execution_Time (WCET_Display);
  end Display_Joystick;

  Procedure Display_Pilot_Presence (PP: in PilotPresence_Type) is      
  begin
    Print_Chrono; 
    Put ("..# ");
    Put ("Pilot ");
  ...
  Procedure Display_Pilot_Button (PB: in PilotButton_Type) is 
  begin
    Print_Chrono;
    Put ("..# ");
    Put ("Button ");
